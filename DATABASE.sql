...
nationality varchar(20), phone varchar(15),
 address varchar(50), aadhar varchar(20),
 gender varchar(20));

create table flight(f_code varchar(20),
 f_name varchar(20), source varchar(40), 
...
create table cancel(pnr varchar(20),
 name varchar(40), cancelno varchar(20),
